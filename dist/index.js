...
// src/postgres-js.ts
var debug = (0, import_driver_adapter_utils2.Debug)("prisma:driver-adapter:postgres-js");
...
var PostgresJsQueryable = class {
  ...
  async queryRaw(query) {
    ...
    try {
      ...
      return (0, import_driver_adapter_utils2.err)(e instanceof Error ? { kind: "GenericJs", id: Date.now() } : e);
    }
  }
  /**
  ...
  async executeRaw(query) {
    ...
    try {
      ...
      return (0, import_driver_adapter_utils2.ok)(rows && rows.length > 0 && "count" in rows[0] ? rows[0].count : rows.length);
    } catch (e) {
      return (0, import_driver_adapter_utils2.err)(e instanceof Error ? { kind: "GenericJs", id: Date.now() } : e);
    }
  }
  ...
  async startTransaction() {
    ...
    return new Promise((resolve, reject) => {
      const txResultPromise = this.client.begin(async (tx) => {
        ...
        resolve((0, import_driver_adapter_utils2.ok)(new PostgresJsTransaction(tx, options, txDeferred, txResultPromise)));
...
var PrismaPostgres = class extends PostgresJsQueryable {
  ...
  async transactionContext() {
    return (0, import_driver_adapter_utils2.ok)(new PostgresJsTransactionContext(this.client));
  }
  async dispose() {
    debug(`[js::dispose]`);
    try {
