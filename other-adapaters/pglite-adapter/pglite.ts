...
import type { PGliteWorker } from "@electric-sql/pglite/dist/worker";
...
class PGliteQueryable<ClientT extends pglite.PGlite | PGliteWorker | pglite.Transaction> implements Queryable {
  readonly provider = "postgres";
  readonly adapterName = "pglite";
  ...
  private async performIO(query: Query): Promise<Result<pglite.Results<unknown>>> {
...
class PGliteTransactionContext extends PGliteQueryable<pglite.PGlite> implements TransactionContext {
...
export class PrismaPGlite extends PGliteQueryable<pglite.PGlite> implements DriverAdapter {
  constructor(
